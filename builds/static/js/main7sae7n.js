...
!function (e) {
  ...
  e.cleanData = (t = e.cleanData, function (i) {
    ...
    var n, a, o, h = {}, u = t.split(".")[0], l = u + "-" + (t = t.split(".")[1]);
    ...
    for (var i, n, a = s.call(arguments, 1), o = 0, h = a.length; o < h; o++) for (i in a[o]) n = a[o][i], a[o].hasOwnProperty(i) && void 0 !== n && (e.isPlainObject(n) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], n) : e.widget.extend({}, n) : t[i] = n);
    return t
  }, e.widget.bridge = function (t, i) {
    var n = i.prototype.widgetFullName || t;
    e.fn[t] = function (a) {
      var o = "string" == typeof a, h = s.call(arguments, 1), u = this;
    ...
    _classes: function (t) {
      ...
      function n(n, a) {
        var o, h;
        for (h = 0; h < n.length; h++) o = s.classesElementLookup[n[h]] || e(), o = t.add ? e(e.unique(o.get().concat(t.element.get()))) : e(o.not(t.element).get()), s.classesElementLookup[n[h]] = o, i.push(n[h]), a && t.classes[n[h]] && i.push(t.classes[n[h]])
      }
    ...
    _on: function (t, i, s) {
      ...
      "boolean" != typeof t && (s = i, i = t, t = !1), s ? (i = n = e(i), this.bindings = this.bindings.add(i)) : (s = i, i = this.element, n = this.widget()), e.each(s, function (s, o) {
        ...
        var u = s.match(/^([\w:-]*)\s*(.*)$/), l = u[1] + a.eventNamespace, r = u[2];
        r ? n.on(l, r, h) : i.on(l, h)
      })
    },
    _off: function (t, i) {
    ...
    e.Widget.prototype["_" + t] = function (s, n, a) {
      ...
      var h = n ? !0 === n || "number" == typeof n ? i : n.effect || i : t;
  ...
  e.widget("ui.mouse", {
    ...
    _createHandles: function () {
      ...
      for (i = s.values && s.values.length || 1, n.length > i && (n.slice(i).remove(), n = n.slice(0, i)), t = n.length; t < i; t++) a.push("<span tabindex='0'></span>");
    ...
    _mouseCapture: function (t) {
      var i, s, n, a, o, h, u, l = this, r = this.options;
      return !r.disabled && (this.elementSize = {
        ...
        (n > i || n === i && (t === l._lastChangedValue || l.values(t) === r.min)) && (n = i, a = e(this), o = t)
    ...
    _refreshValue: function () {
      var t, i, s, n, a, o = this.options.range, h = this.options, u = this, l = !this._animateOff && h.animate, r = {};
      this._hasMultipleValues() ? this.handles.each(function (s) {
        i = (u.values(s) - u._valueMin()) / (u._valueMax() - u._valueMin()) * 100, r["horizontal" === u.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[l ? "animate" : "css"](r, h.animate), !0 === u.options.range && ("horizontal" === u.orientation ? (0 === s && u.range.stop(1, 1)[l ? "animate" : "css"]({left: i + "%"}, h.animate), 1 === s && u.range[l ? "animate" : "css"]({width: i - t + "%"}, {
          queue: !1,
          duration: h.animate
        })) : (0 === s && u.range.stop(1, 1)[l ? "animate" : "css"]({bottom: i + "%"}, h.animate), 1 === s && u.range[l ? "animate" : "css"]({height: i - t + "%"}, {
          queue: !1,
          duration: h.animate
        }))), t = i
      }) : (s = this.value(), n = this._valueMin(), a = this._valueMax(), i = a !== n ? (s - n) / (a - n) * 100 : 0, r["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](r, h.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({width: i + "%"}, h.animate), "max" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({width: 100 - i + "%"}, h.animate), "min" === o && "vertical" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({height: i + "%"}, h.animate), "max" === o && "vertical" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({height: 100 - i + "%"}, h.animate))
    },
    _handleEvents: {
      keydown: function (t) {
...
(function () {
  $('.instruction__header').on('click',function (evt) {
